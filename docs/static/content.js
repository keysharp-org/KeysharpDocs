// Sidebar, toolbar, etc. for the online and offline Keysharp documentation.
...
function setupSite() {
  ...
  favicon.href = site.scriptDir + '/keysharp_logo.png';
...
function setupSiteFrameContent() {
  ...
  content.addSyntaxColors = function(pres) {
    ...
    // Add the independence and provenance statement at the bottom of every page:
    content.addFooter = function() {
      const div = document.createElement('div');
      div.className = 'footer';
      div.innerHTML = '<strong>KeysharpDocs</strong> &middot; Independent Keysharp project &middot; Based on AutoHotkeyDocs with permission &middot; <a href="' + site.urlBase + '/license.htm" class="no-ext">Provenance and licensing</a>';
