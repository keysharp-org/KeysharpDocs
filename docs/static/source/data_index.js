indexData = [
  ...
  ["A_ClipboardTimeout","Variables.htm#A_ClipboardTimeout",1],
  ...
  ["A_Persistent","Variables.htm#A_Persistent",1],
  ...
  ["A_Thread","Variables.htm#A_Thread",1],
  ["A_RealThread","Variables.htm#A_RealThread",1],
  ...
  ["affine drawing transforms (Image)","lib/Image.htm#DrawingState"],
  ...
  ["Audio.DefaultDevice","lib/Audio.htm#DefaultDevice",7],
  ["Audio.Device object","lib/Audio.htm#Device",6],
  ["Audio.Device.Mute","lib/Audio.htm#Device",7],
  ["Audio.Device.IsRunning","lib/Audio.htm#DeviceStatus",7],
  ["Audio.Device.Refresh","lib/Audio.htm#Device",7],
  ["Audio.Device.Status","lib/Audio.htm#DeviceStatus",7],
  ["Audio.Device.ToClr","lib/Audio.htm#Device",7],
  ["Audio.Device.Volume","lib/Audio.htm#Device",7],
  ["Audio.Devices","lib/Audio.htm#Devices",7],
  ["Audio.FromPcm","lib/Audio.htm#FromPcm",7],
  ["Audio.IsDeviceChangeSupported","lib/Audio.htm#IsDeviceChangeSupported",7],
  ["Audio.IsFormatSupported","lib/Audio.htm#IsFormatSupported",7],
  ...
  ["Audio.Load","lib/Audio.htm#Load",7],
  ["Audio.Meter object","lib/Audio.htm#Meter",6],
  ["Audio.Meter.Peak","lib/Audio.htm#Meter",7],
  ["Audio.Meter.Start","lib/Audio.htm#Meter",7],
  ["Audio.Meter.Stop","lib/Audio.htm#Meter",7],
  ["Audio.OnDeviceChange","lib/Audio.htm#OnDeviceChange",7],
  ["Audio.Output object","lib/Audio.htm#Output",6],
  ["Audio.Output.Open","lib/Audio.htm#OutputOpen",7],
  ["Audio.Output.Play","lib/Audio.htm#OutputPlay",7],
  ["Audio.Output.Prepare","lib/Audio.htm#OutputMembers",7],
  ["Audio.Output.StopAll","lib/Audio.htm#OutputStopAll",7],
  ["Audio.Output.TryOpen","lib/Audio.htm#OutputMembers",7],
  ["Audio.Output.VoicePolicy","lib/Audio.htm#VoicePolicy",7],
  ["Audio.Output.Volume","lib/Audio.htm#OutputMembers",7],
  ["Audio.Play","lib/Audio.htm#Play",7],
  ["Audio.Playback object","lib/Audio.htm#Playback",6],
  ["Audio.Playback.Pause","lib/Audio.htm#Playback",7],
  ["Audio.Playback.PositionMilliseconds","lib/Audio.htm#Playback",7],
  ["Audio.Playback.Resume","lib/Audio.htm#Playback",7],
  ["Audio.Playback.Stop","lib/Audio.htm#PlaybackStop",7],
  ["Audio.Recorder object","lib/Audio.htm#Recorder",6],
  ["Audio.Recorder.Start","lib/Audio.htm#Recorder",7],
  ["Audio.Recorder.Stop","lib/Audio.htm#Recorder",7],
  ["Audio.Recording object","lib/Audio.htm#Recording",6],
  ["Audio.Session object","lib/Audio.htm#Session",6],
  ["Audio.Session.Refresh","lib/Audio.htm#Session",7],
  ["Audio.Session.Volume","lib/Audio.htm#Session",7],
  ["Audio.Sessions","lib/Audio.htm#Sessions",7],
  ["Audio.SetApplicationMute","lib/Audio.htm#SetApplicationMute",7],
  ["Audio.SetApplicationVolume","lib/Audio.htm#SetApplicationVolume",7],
  ...
  ["Hex","lib/Hex.htm",6],
  ["Hex.Encode","lib/Hex.htm#Encode",7],
  ["Hex.Decode","lib/Hex.htm#Decode",7],
  ["Base32","lib/Base32.htm",6],
  ["Base32.Decode","lib/Base32.htm#Decode",7],
  ["Base32.Encode","lib/Base32.htm#Encode",7],
  ["Crypt.Hmac","lib/Crypto.htm#Hmac",7],
  ["TOTP","lib/Crypto.htm#ExTotp"],
  ...
  ["Close method (ScriptProcess)","lib/RunScript.htm#Close",7],
  ...
  ["CompileScript","lib/ValidateScript.htm#CompileScript",2],
  ...
  ["Clipboard.Clear","lib/Clipboard.htm#Clear",7],
  ["Clipboard.Files","lib/Clipboard.htm#Files",7],
  ["Clipboard.Formats","lib/Clipboard.htm#Formats",7],
  ["Clipboard.GetData","lib/Clipboard.htm#GetData",7],
  ["Clipboard.Has","lib/Clipboard.htm#Has",7],
  ...
  ["Clipboard.OnChange","lib/Clipboard.htm#OnChange",7],
  ["Clipboard.Rtf","lib/Clipboard.htm#Rtf",7],
  ["Clipboard.Set","lib/Clipboard.htm#Set",7],
  ["Clipboard.Text","lib/Clipboard.htm#Text",7],
  ["Clipboard.Wait","lib/Clipboard.htm#Wait",7],
  ["ClipboardHook object","lib/Clipboard.htm#ClipboardHook",6],
  ["clipping (Image)","lib/Image.htm#DrawingState"],
  ...
  ["DpiChanged (Gui event)","lib/GuiOnEvent.htm#DpiChanged"],
  ...
  ["EndReason property (EventHook)","lib/EventHook.htm#EndReason",7],
  ...
  ["ExitCode property (ScriptProcess)","lib/RunScript.htm#ExitCode",7],
  ["ExitTime property (ScriptProcess)","lib/RunScript.htm#ExitTime",7],
  ...
  ["Font.Exists","lib/Font.htm#Exists",2],
  ["Font.UiDefault","lib/Font.htm#UiDefault",7],
  ...
  ["gradient brushes (Image)","lib/Image.htm#Colors"],
  ...
  ["HasExited property (ScriptProcess)","lib/RunScript.htm#HasExited",7],
  ...
  ["Hooks property","lib/EventHook.htm#Hooks",7],
  ...
  ["Image vector drawing","lib/Image.htm#Paths"],
  ...
  ["InProgress property (EventHook)","lib/EventHook.htm#InProgress",7],
  ...
  ["IsComponentAvailable","lib/IsComponentAvailable.htm",2],
  ...
  ["Kill method (ScriptProcess)","lib/RunScript.htm#Kill",7],
  ...
  ["ListView.ClearColors","lib/ListView.htm#ClearColors",7],
  ["ListView.SetCellColor","lib/ListView.htm#SetCellColor",7],
  ["ListView.SetRowColor","lib/ListView.htm#SetRowColor",7],
  ...
  ["OnActive property (WinEvent)","lib/WinEvent.htm#OnActive",7],
  ["OnCaretMove property (WinEvent)","lib/WinEvent.htm#OnCaretMove",7],
  ...
  ["OnMinimize property (WinEvent)","lib/WinEvent.htm#OnMinimize",7],
  ...
  ["OnMove property (WinEvent)","lib/WinEvent.htm#OnMove",7],
  ...
  ["OnNotActive property (WinEvent)","lib/WinEvent.htm#OnNotActive",7],
  ["OnNotExist property (WinEvent)","lib/WinEvent.htm#OnNotExist",7],
  ...
  ["persistent scripts (event hooks)","lib/EventHook.htm#Persistence"],
  ...
  ["ReplaceLineEndings","lib/StringFunctions.htm#ReplaceLineEndings",2],
  ...
  ["ScriptProcess","lib/RunScript.htm#ScriptProcess",6],
  ["Scripts","Scripts.htm"],
  ...
  ["StdErr property (ScriptProcess)","lib/RunScript.htm#StdErr",7],
  ["StdIn property (ScriptProcess)","lib/RunScript.htm#StdIn",7],
  ["StdOut property (ScriptProcess)","lib/RunScript.htm#StdOut",7],
  ["space","lib/Is.htm"],
  ...
  ["Start method (EventHook)","lib/EventHook.htm#Start",7],
  ...
  ["Stop method (EventHook)","lib/EventHook.htm#Stop",7],
  ...
  ["ValidateScript","lib/ValidateScript.htm",2],
  ...
  ["vector paths (Image)","lib/Image.htm#Paths"],
